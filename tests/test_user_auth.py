...
class TestUserAuth(BaseCase):
    ...
    def setup(self):
        ...
        link1 = "https://playground.learnqa.ru/api/user/login"
        self.link2 = "https://playground.learnqa.ru/api/user/auth"
        response1 = requests.post(link1, data=data)
    ...
    def test_negative_auth_check(self, condition):
        if condition == "no_cookie":
            ...
            response2 = requests.get(self.link2, cookies={"auth_sid": self.auth_sid})
